  ...
  return (
    <section id="projects" className="py-24 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-20">
        <h2 className="text-4xl md:text-6xl font-black mb-4 tracking-tighter text-white">הזרקת קוד למציאות</h2>
        <p className="text-gray-500 font-mono text-sm">{" > "} פרויקטים נבחרים וכלים אינטראקטיביים</p>
      </div>

      <div className="grid md:grid-cols-2 gap-8 lg:gap-12 text-right" dir="rtl">
        {PROJECTS.map((project, idx) => {
          ...
          return (
            <Wrapper key={idx} {...(props as any)} className="group relative block w-full h-[400px] md:h-[450px] rounded-[2.5rem] overflow-hidden border border-white/5 bg-black transition-transform duration-500 hover:-translate-y-2 text-right">
              ...
              <div className="absolute bottom-10 left-10 right-10 z-20 text-right">
                ...
                <p className="text-gray-300 text-sm mb-8 max-w-3xl opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 text-right">
                  {isAudit 
                ...
                <div className="inline-flex items-center gap-4 text-white font-black text-[10px] uppercase tracking-[0.3em] group-hover:text-cyan-400 transition-all flex-row-reverse">
